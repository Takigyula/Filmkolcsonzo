...
//   };
  ...
  return (
    ...
    <body>
      <header>
    <nav>
      <div className="logo">DevlyCode.</div>
    ...
    <div className="Slider">
      <div className="slider">
        <div className="slider">
          <div className="slider">
            <img src="../assets/images/snowfall2.jpg" alt="" />
            <div className="slideInfo">
              <div className="infoWrapper">
                <div className="info">
                  <img src="../assets/images/vajak" alt="" />
                  <div className="raitings">
                    <p className="raiting">******</p>
                    <p className="category"><span>Action</span>DevilyCode.game.comp.</p>
                  </div>
                </div>
              <info className="title">Echoes Destiny</info>
              </div>
      ...
      <div className="sliderThumbs"></div>
    </div>
    </body>
    </html>
  );
