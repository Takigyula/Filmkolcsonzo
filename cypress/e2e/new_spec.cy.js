describe('Subscription Functionality', () => {
    it('should click the second subscription button and fill in the data', () => {
        // Visit the page containing the subscription buttons
        cy.visit('/path-to-your-subscription-page');

        // Click the second subscription button
        cy.get('#second-subscription-button').click(); // Adjust the selector as needed
